...
ggplot() + 
  ...
  scale_fill_viridis_c(name ='saledecile')+
  ggtitle("Milwaukee!") + 
...
ggplot() + 
  ...
  geom_sf(fill = 'transparent', color='white', data = temp) + 
  scale_fill_viridis_c(name ='Percent_Black')+
  ggtitle("Milwaukee!") + 
  theme(axis.text.x = element_blank(),
        axis.text.y = element_blank()) + coord_sf()
...
ggplot() + 
  ...
  geom_sf(fill = 'transparent', color='white', data = temp) + 
  scale_fill_viridis_c(name ='Percent_White')+
  ggtitle("Milwaukee!") + 
  theme(axis.text.x = element_blank(),
        axis.text.y = element_blank()) + coord_sf()
...
ggplot() + 
  ...
  geom_sf(fill = 'transparent', color='white', data = temp) + 
  scale_fill_viridis_c(name ='IncomeDecile')+
  ggtitle("Milwaukee!") + 
  theme(axis.text.x = element_blank(),
        axis.text.y = element_blank()) + coord_sf()
