...
corrplot(dist,method='circle', type = 'lower', tl.col="black")

dist;Tract_cors


setdiff(unique(cors$MEDIAN.INCOME),unique(Tract_independents$MEDIAN.INCOME))

unique(cors$MedianATSRatio)
unique(Tract_independents$MedianATSRatio)

Tract_independents ; cors
