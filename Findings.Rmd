...
cat("In the first model we see that Log Median Tract Income has a coefficient equal to 0.1710","\n")
cat("Which is about 17% of a standard deviation","\n")
cat("---","\n")

cat("So, 17% of", ATSRatio_stdev,"is:",ATSRatio_stdev*0.17,"or 2.22%", "\n")
cat("---","\n")
...
mod <- lmer(atsratio ~ LogMedianIncome + LogMedianLandSize + PctLandSizeDiff_Above + PctLandSizeDiff_Below  + LogMedianTractSalesPrice  + PctSalePriceDiff_Above + PctSalePriceDiff_Below + (1|GEO_TRACT) + KITCHENS+ FULLBATHS+ HALFBATH + BEDROOMS + KITCHEN_FAC + COND_FAC + QUAL_FAC + TYPE_FAC + PRIM_WALL + salemonth + saleyear, data = fitdata)
...
cat("In this model we see that Percent Black Population has a coefficient equal to -0.223","\n")
cat("Which is about 22% of a standard deviation","\n")
cat("---","\n")

cat("So, 22% of", ATSRatio_stdev,"is:",ATSRatio_stdev*0.223,"or 2.29%", "\n")
cat("---","\n")

cat("In other words, a neighboorhood with a one standard deviation increase in the Percent Black Population is subject to a 2.29% decrease in their taxable property value","\n")

cat("---","\n")

cat("This is the difference between an annual property tax bill of $1000 versus $",1000-(1000*(ATSRatio_stdev*0.223)),"\n")
...
cat("In this model we see that Percent White Population has a coefficient equal to 0.3487","\n")
cat("Which is about 35% of a standard deviation","\n")
cat("---","\n")

cat("So, 35% of", ATSRatio_stdev,"is:",ATSRatio_stdev*0.3487,"or 4.57%", "\n")
cat("---","\n")
...
cat("This is the difference between an annual property tax bill of $1000 versus $",1000+(1000*(ATSRatio_stdev*0.3487)),"\n")
