...
ggplot(resdata, aes(atsratio)) +
  ...
  xlab("ATS Ratio") +
  ylab("Frequency") + 
  ggtitle("Distribution of ATS Ratio")
...
ggplot(filter(resdata, Majority_Black ==1), aes(atsratio)) +
  ...
  xlab("ATS Ratio") +
  ylab("Frequency") + 
  ggtitle("Distribution of ATS Ratio for Majority Black Neighborhoods")
...
ggplot(filter(resdata, Majority_Black ==1), aes(atsratio)) +
  ...
  xlab("ATS Ratio") +
  ylab("Frequency") + 
  ggtitle("Scaled Down: Distribution of ATS Ratio for Majority Black Neighborhoods")
...
ggplot(filter(resdata, Majority_Black ==0), aes(atsratio)) +
  ...
  xlab("ATS Ratio") +
  ylab("Frequency") + 
  ggtitle("Distribution of ATS Ratio for Majority Non-Black Neighborhoods")
...
ggplot(filter(resdata, Majority_White ==1), aes(atsratio)) +
  ...
  xlab("ATS Ratio") +
  ylab("Frequency")+ 
  ggtitle("Distribution of ATS Ratio for Majority White Neighborhoods")
```
  
Unmatched Logistic Regressions
```{r}
