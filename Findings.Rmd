...
fitdata <- resdata  %>%
  select(atsratio,
         Percent_Black,LANDSIZE, SALEPRICE, MEDIAN.INCOME,age) %>% 
...
mod <- lm(atsratio ~   Percent_Black + LANDSIZE + SALEPRICE + MEDIAN.INCOME + KITCHENS+ FULLBATHS+ HALFBATH + BEDROOMS + KITCHEN_FAC + COND_FAC + QUAL_FAC + TYPE_FAC + PRIM_WALL + salemonth + saleyear + age, data = fitdata)
...
Transformed Sale Price, Land Size, and Median Income 
...
fitdata <- resdata  %>%
  select(atsratio,
         Percent_NotHispanic_White,Percent_Hispanic,
         Percent_Black,LogMedianIncome,LogLandSize, LogSalesPrice,age) %>% 
  scale(center = T,scale=T) %>%
  as.data.frame()
...
mod <- lm(atsratio ~  Percent_Black + Percent_NotHispanic_White +  Percent_Hispanic + LogLandSize + LogMedianIncome+ LogSalesPrice  + KITCHENS+ FULLBATHS+ HALFBATH + BEDROOMS + KITCHEN_FAC + COND_FAC + QUAL_FAC + TYPE_FAC + PRIM_WALL + salemonth + saleyear + age, data = fitdata)
...
mod <- lm(atsratio ~  Percent_NotHispanic_White +  Percent_Hispanic + LogLandSize + LogMedianIncome+ LogSalesPrice  + KITCHENS+ FULLBATHS+ HALFBATH + BEDROOMS + KITCHEN_FAC + COND_FAC + QUAL_FAC + TYPE_FAC + PRIM_WALL + salemonth + saleyear + age, data = fitdata)
...
This doesnt really work each needs to be scaled
```{r}

mod0 <- lmer(atsratio ~  LogMedianLandSize + PctLandSizeDiff_Above + PctLandSizeDiff_Below  + LogMedianTractSalesPrice  + PctSalePriceDiff_Above + PctSalePriceDiff_Below + (1|GEO_TRACT) + KITCHENS+ FULLBATHS+ HALFBATH + BEDROOMS + KITCHEN_FAC + COND_FAC + QUAL_FAC + TYPE_FAC + PRIM_WALL + salemonth + saleyear + age, data = fitdata)


mod1 <- lmer(atsratio ~  LogMedianIncome + LogMedianLandSize + PctLandSizeDiff_Above + PctLandSizeDiff_Below  + LogMedianTractSalesPrice  + PctSalePriceDiff_Above + PctSalePriceDiff_Below + (1|GEO_TRACT) + KITCHENS+ FULLBATHS+ HALFBATH + BEDROOMS + KITCHEN_FAC + COND_FAC + QUAL_FAC + TYPE_FAC + PRIM_WALL + salemonth + saleyear + age, data = fitdata)

mod2 <- lmer(atsratio ~  Percent_NotHispanic_White  + LogMedianIncome + LogMedianLandSize + PctLandSizeDiff_Above + PctLandSizeDiff_Below  + LogMedianTractSalesPrice  + PctSalePriceDiff_Above + PctSalePriceDiff_Below + (1|GEO_TRACT) + KITCHENS+ FULLBATHS+ HALFBATH + BEDROOMS + KITCHEN_FAC + COND_FAC + QUAL_FAC + TYPE_FAC + PRIM_WALL + salemonth + saleyear + age, data = fitdata)

mod3 <- lmer(atsratio ~ Percent_Black + Percent_NotHispanic_White  + LogMedianIncome + LogMedianLandSize + PctLandSizeDiff_Above + PctLandSizeDiff_Below  + LogMedianTractSalesPrice  + PctSalePriceDiff_Above + PctSalePriceDiff_Below + (1|GEO_TRACT) + KITCHENS+ FULLBATHS+ HALFBATH + BEDROOMS + KITCHEN_FAC + COND_FAC + QUAL_FAC + TYPE_FAC + PRIM_WALL + salemonth + saleyear + age, data = fitdata)

mod4 <- lmer(atsratio ~ Percent_Black + Percent_NotHispanic_White +  Percent_Hispanic + LogMedianIncome + LogMedianLandSize + PctLandSizeDiff_Above + PctLandSizeDiff_Below  + LogMedianTractSalesPrice  + PctSalePriceDiff_Above + PctSalePriceDiff_Below + (1|GEO_TRACT) + KITCHENS+ FULLBATHS+ HALFBATH + BEDROOMS + KITCHEN_FAC + COND_FAC + QUAL_FAC + TYPE_FAC + PRIM_WALL + salemonth + saleyear + age, data = fitdata)

mod5 <- lmer(atsratio ~   Percent_Hispanic + LogMedianIncome + LogMedianLandSize + PctLandSizeDiff_Above + PctLandSizeDiff_Below  + LogMedianTractSalesPrice  + PctSalePriceDiff_Above + PctSalePriceDiff_Below + (1|GEO_TRACT) + KITCHENS+ FULLBATHS+ HALFBATH + BEDROOMS + KITCHEN_FAC + COND_FAC + QUAL_FAC + TYPE_FAC + PRIM_WALL + salemonth + saleyear + age, data = fitdata)



anova(mod0,mod3,mod1,mod2,mod4)
anova(mod0,mod5)
```
...
age <- matrix(c(2655,716,2347,1024),ncol=2,byrow=TRUE)
colnames(age) <- c("Over 24","17-24")
rownames(age) <- c("Sheridan","Control")
age <- as.table(age)
age
