...
mod1 <- glm(ATSDev_Indicator_LOW ~ Majority_Black + SALEPRICE + 
              PctLandSizeDiff_Above + PctLandSizeDiff_Below + 
              age +
              KITCHENS+ FULLBATHS+ HALFBATH + BEDROOMS + KITCHEN_FAC + COND_FAC + QUAL_FAC + TYPE_FAC + 
...
mean(df.match$LogSalesPrice)
exp(11.71623) - exp(11.71623 + 1) 
