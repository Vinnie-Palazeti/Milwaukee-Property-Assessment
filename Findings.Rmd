...
# Need to do Grouped LASSO


# In order to do Grouped LASSO I need to use the dummy variables for the categorical groups
...
cv <-cv.gglasso(x = X, y = Y, group = group, loss = "ls",
           pred.loss = "L1",lambda.factor = 0.005, nfolds=5)
