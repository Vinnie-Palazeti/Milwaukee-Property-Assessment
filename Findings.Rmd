...
lasso_data <- fitdata %>% select(-c("GEO_TRACT", "Percent_Renter"))
...
fitdata <- resdata %>% 
  select(atsratio,
         Percent_Black,
         PctSalePriceDiff_Below,PctSalePriceDiff_Above,PctSalePriceDiff_Below,
         LogMedianIncome,LogMedianTractSalesPrice, LANDSIZE,
         GEO_TRACT)
...
covariates <- resdata %>% select(KITCHEN_FAC, COND_FAC, QUAL_FAC, BATH_FAC,TYPE_FAC, KITCHENS, FULLBATHS, BEDROOMS,HALFBATH )


fitdata <- cbind(fitdata,covariates)


mod <- lmer(atsratio ~ LogMedianIncome + Percent_Black + LANDSIZE + LogMedianTractSalesPrice  + PctSalePriceDiff_Above + PctSalePriceDiff_Below + (1|GEO_TRACT) + KITCHENS+ FULLBATHS+ HALFBATH + BEDROOMS + KITCHEN_FAC + COND_FAC + QUAL_FAC + TYPE_FAC, data = fitdata)
...
mod <- lmer(atsratio ~ LogMedianIncome + Percent_Hispanic + LANDSIZE + LogMedianTractSalesPrice  + PctSalePriceDiff_Above + PctSalePriceDiff_Below + (1|GEO_TRACT) + KITCHENS+ FULLBATHS+ HALFBATH + BEDROOMS + KITCHEN_FAC + COND_FAC + QUAL_FAC + TYPE_FAC, data = fitdata)
...
mod <- lmer(atsratio ~ LogMedianIncome + Percent_NotHispanic_White + LANDSIZE + LogMedianTractSalesPrice  + PctSalePriceDiff_Above + PctSalePriceDiff_Below + (1|GEO_TRACT) + KITCHENS+ FULLBATHS+ HALFBATH + BEDROOMS + KITCHEN_FAC + COND_FAC + QUAL_FAC + TYPE_FAC, data = fitdata)
...
mod <- lmer(atsratio ~ LogMedianIncome + Percent_TotalPOPIncomeBelowPovRate + LANDSIZE + LogMedianTractSalesPrice  + PctSalePriceDiff_Above + PctSalePriceDiff_Below + (1|GEO_TRACT) + KITCHENS+ FULLBATHS+ HALFBATH + BEDROOMS + KITCHEN_FAC + COND_FAC + QUAL_FAC + TYPE_FAC, data = fitdata)
...
Focus Just on Income 
```{r}
fitdata <- resdata %>% 
  select(atsratio, Percent_Black, Percent_NotHispanic_White, Percent_Hispanic,
         PctSalePriceDiff_Below,PctSalePriceDiff_Above,PctSalePriceDiff_Below,
         LogMedianIncome,LogMedianTractSalesPrice, LANDSIZE,
         GEO_TRACT)
...
mod <- lmer(atsratio ~ LogMedianIncome + Percent_Black + Percent_NotHispanic_White + LANDSIZE +Percent_Hispanic + LogMedianTractSalesPrice  + PctSalePriceDiff_Above + PctSalePriceDiff_Below + (1|GEO_TRACT) + KITCHENS+ FULLBATHS+ HALFBATH + BEDROOMS + KITCHEN_FAC + COND_FAC + QUAL_FAC + TYPE_FAC, data = fitdata)
...
covariates <- resdata %>% select(IncomeDecile,KITCHEN_FAC, COND_FAC, QUAL_FAC, BATH_FAC,TYPE_FAC, KITCHENS, FULLBATHS, BEDROOMS,HALFBATH )


fitdata <- cbind(fitdata,covariates)


mod <- lmer(atsratio ~  IncomeDecile + LogMedianTractSalesPrice  + PctSalePriceDiff_Above + LANDSIZE + PctSalePriceDiff_Below + (1|GEO_TRACT) + KITCHENS+ FULLBATHS+ HALFBATH + BEDROOMS + KITCHEN_FAC + COND_FAC + QUAL_FAC + TYPE_FAC, data = fitdata)
...
filtdata <- resdata %>% filter(blackdecile > 7)
...
covariates <- resdata %>% filter(blackdecile > 7) %>% select(LogMedianIncome,KITCHEN_FAC, COND_FAC, QUAL_FAC, BATH_FAC,TYPE_FAC, KITCHENS, FULLBATHS, BEDROOMS,HALFBATH )


fitdata <- cbind(fitdata,covariates)


mod <- lmer(atsratio ~  LogMedianIncome + LogMedianTractSalesPrice  + LANDSIZE + PctSalePriceDiff_Above + PctSalePriceDiff_Below + (1|GEO_TRACT) + KITCHENS+ FULLBATHS+ HALFBATH + BEDROOMS + KITCHEN_FAC + COND_FAC + QUAL_FAC + TYPE_FAC, data = fitdata)
